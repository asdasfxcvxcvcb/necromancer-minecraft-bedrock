...
if (-not [string]::IsNullOrWhiteSpace($Configuration) -and
    ...
    Write-Host "Skipping Necromancer UTC build timestamp stamp for $Configuration configuration"
    return
}
...
Write-Host "Stamped Necromancer UTC build timestamp $Timestamp into $BinaryPath"
